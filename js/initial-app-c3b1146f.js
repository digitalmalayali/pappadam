...
define(["require", "exports"], (function(e, t) {
    ...
    const ie = [{
            ...
            size: "1.7mb",
            filename: "pixel3.png",
            url: "/img/demo-device-screen-b9d088e8.png",
    ...
    class ae extends f {
        ...
        render({}, {
            ...
            return p("div", {
                ...
                class: J
            }, "കുഞ്ഞൻ ചിത്രങ്ങൾ കൂടുതൽ വേഗത്തിൽ ലോഡാവുന്നു. ഉയർന്ന ഗുണമേന്മ നിലനിർത്തിക്കൊണ്ട് ഫയലിന്റെ വലിപ്പം കുറയ്ക്കാൻ ‘പപ്പടത്തിനാകും’.")), p("div", {
                class: X
            }, p("img", {
                class: $,
                ...
                class: J
            }, "ചിത്രം തുറന്ന്, മാറ്റങ്ങൾ നോക്കിയിട്ട്, ഉടനെ സേവ് ചെയ്യുക. സാഹസികത ഇഷ്ടമാണോ? ഇതിലും കുഞ്ഞൻ ഫയലുകൾ ലഭിക്കാൻ ക്രമീകരണങ്ങൾ നിയന്ത്രിക്കുക.")), p("div", {
                class: X
            }, p("img", {
                class: $,
                ...
                class: J
            }, "സ്വകാര്യതയെപ്പറ്റി ആശങ്കയുണ്ടോ? ചിത്രങ്ങൾ നിങ്ങളുടെ ഡിവൈസിൽ നിന്ന് പുറത്തേക്ക് പോവുന്നില്ല. കാരണം, ‘പപ്പടം’ പണിയെടുക്കുന്നത് ലോക്കലായാണ്.")), p("div", {
                class: X
            }, p("img", {
                class: $,
